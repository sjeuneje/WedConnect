...
export default function Topbar({ currentPage }: Props) {
    return (
        <div className="fixed top-0 left-[250px] right-0 h-[75px] border-b border-gray-200 bg-[#FDFDFC] p-4 text-sm font-medium opacity-100 transition-opacity duration-750 grow starting:opacity-0">
